/**
 * BACKUP — Full-funnel coaching page (Wall of Love, CTAs, FAQ, Process, etc.)
 * Saved 2026-02-26 before rewrite to low-pressure version.
 * Not deployed — underscore prefix makes Next.js ignore this file.
 * To restore: rename to page.tsx and restore original component files.
 */
...
export default function CoachingPageV1() {
  return (
    <>
    <script
